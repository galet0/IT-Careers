...
namespace ChefsKingdom
{
    class Program
    {
        ...
        private static void PrintDishInfoByName(string[] dishInfo)
        {
            ...
            {
                Console.WriteLine("Invalid dish {0}", dishName);
        ...
        private static void PrintChefInfoByName(string[] chefInfo)
        {
            ...
            if (!chefs.ContainsKey(name))
            {
                Console.WriteLine("Invalid chef {0}", name);
        ...
        private static void RemoveDishFromSpecificChef(string[] info)
        {
           ...
           bool removed =  chef.RemoveDish(dish);
            ...
            if (removed)
            {
                Console.WriteLine("Successfully removed dish: {0} from chef {1}!", dish.Name, dish.Name);
        ...
        private static void RemoveAllDishesByFoodGroupFromSpecificChef(string[] info)
        {
            ...
            if (removed)
            {
                Console.WriteLine("Successfully removed dishes with food group: {0} from chef {1}!", foodGroup, chef.Name);
        ...
        private static void DeliverDish(string[] info)
        {
            ...
            if (cooked == null)
            {
                Console.WriteLine("Chef {0} failed to cook {1}!", chef.Name, dishName);
                  
                  
            }
            else
            {
                Console.WriteLine("Chef {0} successfully cooked {1}", chef.Name, dishName);
        ...
        private static void IsChefAvailable(string[] info)
        {
            ...
            if (isAvailable)
            {
                Console.WriteLine("Chef {0} is available!", chef.Name);
                  
                  
            }
            else
            {
                Console.WriteLine("Chef {0} is NOT available!", chef.Name);
